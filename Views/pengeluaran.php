      ...
      <table>
        ...
        <tr>
          <?php while ($row = mysqli_fetch_assoc($query)) : ?>
            ...
            <td>
              <a href="editPengeluaran.php?id=<?= $row['id_pengeluaran'] ?>">Edit</a> |
              <a href="hapusPengeluaran.php?id=<?= $row['id_pengeluaran'] ?>" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
            </td>
          <?php endwhile; ?>
        </tr>
      </table>
